...
const Cols = ({index, style}) => {
  let pos1 = [0,1,2,3,4].includes(index) ? 'bottom-right' : 'right';
  let pos2 = [0,1,2,3,4].includes(index) ? 'bottom-left' : 'left';
  return(
    <div className="span-cols-square mx-auto" style={style}>
      <div className="square my-tooltip">
        <span className={"tooltiptext " + pos1}>
          {'(' + (index+1) + ',1)'}
        </span>
      </div>
      <div className="square my-tooltip">
    ...
    <div className="square my-tooltip">
    <span className={"tooltiptext " + pos2}>
